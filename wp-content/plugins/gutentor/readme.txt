...
Gutentor elements are conceptualized to use inside the Gutentor Module but of course, you can use it anywhere on your editor.
...
We have the plan to develop more gutentor elements and gutentor module on the coming version.
...
* Fixed : Typography
* Update : Faster Dynamic CSS
* Update : Optimized Blocks
* Update : Some Design Issue
